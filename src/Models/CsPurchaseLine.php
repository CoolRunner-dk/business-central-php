...
/**
 *
 * Class CsPurchaseLine
 *
 * @see https://github.com/CoolRunner-dk/business-central-php/blob/master/entities.md#cspurchaseline
 *
 ...
 *
 */
class CsPurchaseLine extends Entity
{
    protected static $schema_type = 'CS_PurchaseLine';
