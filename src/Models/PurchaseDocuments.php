 ...
 *
 * @see https://github.com/CoolRunner-dk/business-central-php/blob/master/entities.md#purchasedocuments
 *
 ...
 *
 */
class PurchaseDocuments extends Entity
{
    protected static $schema_type = 'purchaseDocuments';
