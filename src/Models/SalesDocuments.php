 ...
 *
 * @see https://github.com/CoolRunner-dk/business-central-php/blob/master/entities.md#salesdocuments
 *
 ...
 *
 */
class SalesDocuments extends Entity
{
    protected static $schema_type = 'salesDocuments';
